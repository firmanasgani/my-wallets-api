...
export class AccountsController {
    ...
    create(
        ...
        return this.accountService.create(user.id, createAccountDto, ipAddress, userAgent);
    }
    ...
    update(
        ...
        const ipAddress = req.ip
        const userAgent = req.headers['user-agent']
        return this.accountService.update(user.id, id, updateAccountDto, ipAddress, userAgent);
    }
